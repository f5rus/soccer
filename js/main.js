...
$(document).ready(function(){
    ...
    setEqualHeight($('#leftmenu,.left-sidebar, .right-sidebar, .container, .container .main')); 
...
$(function(){ 
    ...
    $('div#scrollTop').click(function () {$('body,html').animate({scrollTop:0},500); return false;});
});
