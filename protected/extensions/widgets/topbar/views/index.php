...
<div id="header2"><div id="headerbar2-inner">
        <div id="header-inner">
            ...
            <ul id="nav">
                ...
                <?php else: ?>
                <li id="t-signin">
                    <a href="<?php  echo Yii::app()->CreateUrl("//login"); ?>"><span>Войти</span></a><span class="loginsocial"><span title="Совсем скоро" class="ls_facebook south"></span><a class="ls_twitter" href="<?php echo Yii::app()->baseUrl."/login/facebook"; ?>">&nbsp;</a><a class="ls_in" href="<?php echo Yii::app()->baseUrl."/login/vkontakte"; ?>">&nbsp;</a></span>
                </li>
                ...
                <li id="t-shots">
                    <a href="#">Быстрая навигация</a>
                    <ul class="tabs">
                        <li class=""><a href="<?php echo Yii::app()->request->baseUrl; ?>">Главная страница</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/post'); ?>">Новости</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/fixtures'); ?>"><strong>Расписание матчей</strong></a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/video'); ?>">Видеоархив</a></li>
                    </ul>
                </li>

               <li id="t-teams">
                    <a href="#" class="has-sub">Сезон</a>
                    <ul class="tabs">
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/results'); ?>">Результаты матчей</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/fixtures'); ?>">Расписание 2014/2015</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/table'); ?>">Турнирная таблица</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/topscorers'); ?>">Бомбардиры</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/table'); ?>">Статистика</a></li>
                    </ul>
                </li>

                <li id="t-players">
                    <a href="<?php echo Yii::app()->CreateUrl('/forecast/forecast'); ?>" class="has-sub"><strong>Конкурс прогнозов</strong></a>
                </li>

                <li id="t-jobs">
                    <a href="<?php echo Yii::app()->CreateUrl('/team'); ?>">Информация</a>
                    <ul class="tabs">
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/team'); ?>">Список команд</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/player'); ?>">Игроки</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/stadium'); ?>">Стадионы</a></li>
                        <li class=""><a href="<?php echo Yii::app()->CreateUrl('/coach'); ?>">Тренера</a></li>
                    </ul>
                </li>
                ...
                <li id="t-more">
                    ...
                    <ul class="tabs">
                        <li></li><li class=""><a href="<?php echo Yii::app()->CreateUrl('/users'); ?>">Пользователи</a></li>

                        <li></li><li class=""><a href="<?php echo Yii::app()->CreateUrl('/rules'); ?>">Правила сайта</a></li>
                        <li></li><li class=""><a href="<?php echo Yii::app()->CreateUrl('/tags'); ?>">Тэги</a></li>
                        <li><a href="<?php echo Yii::app()->CreateUrl('/about'); ?>">О сайте</a></li>
                        <li  class="separate"><a href="<?php echo Yii::app()->CreateUrl('/api/docs'); ?>"><b>API для разработчиков</b></a></li>
                        <li><a href="<?php echo Yii::app()->CreateUrl('/feedback'); ?>">Отправить e-mail</a></li>
