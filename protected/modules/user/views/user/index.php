<?php
$this->setPageTitle(UserModule::t("Users"));
if(UserModule::isAdmin()) {
	$this->layout='//layouts/column2';
	$this->menu=array(
	    array('label'=>UserModule::t('Управ. пользователями'), 'url'=>array('/user/admin')),
	    array('label'=>UserModule::t('Настройка полей'), 'url'=>array('profileField/admin')),
	);
}
?>
...
<?php $this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        ...
        array('name' => UserModule::t("Users")),
    )
)); ?>


<h1 class="h1content"><?php echo UserModule::t("Users"); ?></h1>
