...
$this->setPageTitle("Ваши подписки");
?>

<?php $this->widget('application.components.BreadCrumb', array(
    'crumbs' => array(
        array('name' => 'Главная', 'url' => array('/')),
        array('name' => "Ваши подписки"),
    )
)); ?>

<h1 class="h1content"><?php echo 'Ваши подписки'; ?><?php if ($countUser>0) echo "(".$countUser.")"; ?></h1>


<?php $this->renderPartial('//../modules/friend/views/friend/default/friends_nav',array('friend'=>'','fol'=>'','sub'=>'active')); ?>

<?php
 if ($countUser<1): ?> Вы не на кого не подписаны
<?php else:?>
...
<div id="createurl-userpage" style="display:none;"><?php echo Yii::app()->CreateUrl("/friend/my/followers/User_page")."/";?></div>
<script>
